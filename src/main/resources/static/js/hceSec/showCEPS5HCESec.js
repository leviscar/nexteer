...
function showWeek() {
    ...
    var urlString = "http://10.1.0.40:8080/nexteer/hce/week/CEPS5?date="+curr_time;
    $.ajax({
        headers: {
...
$("#showMonth").bind("click",function (){
    ...
    $(document).ready(function () {
        ...
        console.log(MonthDate[d.getDate()-1]);
        {
            ...
            var IshaftOnehceValueArr=[];
            var IshaftOnehceTarArr=[];
            var urlString = "http://10.1.0.40:8080/nexteer/hce/month/CEPS5?date="+curr_time;
            $.ajax({
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
...
$("#showYear").bind("click",function () {
    ...
    console.log(YearDate);
    {
        ...
        var IshaftOnehceValueArr=[];
        var IshaftOnehceTarArr=[];
        var urlString = "http://10.1.0.40:8080/nexteer/hce/year/CEPS5?date="+curr_time;
        $.ajax({
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
