...
function getNowStatus() {
    ...
    var getString="http://localhost:8080/nexteer/unit-status/record/ISHAFT3?date="+nowTime+"&shift_type="+shift;
        ...
        success: function (data) {
            ...
            if(data.id == null){
            ...
            }else {
                {
                    ...
                    $("#target").html(data.calculatedTarget);$("#cTarget").html(data.target);
                    var i=0;
