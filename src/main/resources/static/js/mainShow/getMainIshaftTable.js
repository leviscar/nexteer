...
var link = ["http://localhost:8080/nexteer/html/Ishaft1Unit.html","http://localhost:8080/nexteer/html/Ishaft1Unit.html","http://localhost:8080/nexteer/IshaftTwoUnit.html","http://localhost:8080/nexteer/IshaftTwoUnit.html"];

function change(n){
    getMainOee();
    if(n>IshaftTitle.length-1) n=0;  //
    $("#showIshaft").replaceWith("<div class=\"col-md-8 ftqTitle text-center \"><a href=\"http://localhost:8080/nexteer/html/oeeSec/ishaft1OEESec.html\">ISHAFT1</a></div>");
