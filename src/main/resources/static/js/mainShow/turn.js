...
var IshaftOEEHref=["http://localhost:8080/nexteer/html/oeeSec/ishaft1OEESec.html","http://localhost:8080/nexteer/html/oeeSec/ishaft2OEESec.html",
    "http://localhost:8080/nexteer/html/oeeSec/ishaft1OEESec.html","http://localhost:8080/nexteer/html/oeeSec/ishaft1OEESec.html"];

var IshaftHCEHref=["http://localhost:8080/nexteer/html/hceSec/ishaft1HceSec.html","http://localhost:8080/nexteer/html/hceSec/ishaft2HceSec.html",
    "http://localhost:8080/nexteer/html/hceSec/ishaft3HceSec.html","http://localhost:8080/nexteer/html/hceSec/ishaft4HceSec.html"];
...
function change(n){
    ...
    $.get("http://localhost:8080/nexteer/dashboard/oee/"+IshaftTitle[n]+"?time="+currTime,function (data) {
    ...
    $.get("http://localhost:8080/nexteer/dashboard/hce/"+IshaftTitle[n]+"?time="+currTime,function (data) {
