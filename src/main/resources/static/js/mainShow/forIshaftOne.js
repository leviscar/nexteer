...
function getMainOee() {
    ...
    $.get("http://localhost:8080/nexteer/dashboard/oee/BEPS?time="+currTime,function (data) {
        if($.parseJSON(data).system_status != false){
            if($.parseJSON(data).open != false){
                console.log(JSON.stringify(data));
    ...
    $.get("http://localhost:8080/nexteer/dashboard/oee/CEPS?time="+currTime,function (data) {
        if($.parseJSON(data).system_status != false){
            if($.parseJSON(data).open != false){
                console.log(JSON.stringify(data));
...
function getMainPro() {
    ...
    $.get("http://localhost:8080/nexteer/dashboard/output/ISHAFT1?time="+currTime,function (data) {
        if($.parseJSON(data).system_status != false){
            if($.parseJSON(data).open != false){
                ...
                {
                    case -1:
                        $("#status").replaceWith("<td class=\" noPadding\" id=\"status\"><a href=\"http://localhost:8080/nexteer/Ishaft1Unit.html\"><img  src=\"images/down.png\" alt=\"NICE\"></a></td>");
                        break;
                    case 0:
                        $("#status").replaceWith("<td class=\" noPadding\" id=\"status\"><a href=\"http://localhost:8080/nexteer/Ishaft1Unit.html\"><img class=\"slider\" src=\"images/slider.png\" alt=\"NICE\"></a></td>");
                        break;
                    case 1:
                        $("#status").replaceWith("<td class=\" noPadding\" id=\"status\"><a href=\"http://localhost:8080/nexteer/Ishaft1Unit.html\"><img  src=\"images/up.png\" alt=\"NICE\"></a></td>");
                        break;
                    default:
                        $("#status").replaceWith("<td class=\" noPadding\" id=\"status\"><a href=\"http://localhost:8080/nexteer/Ishaft1Unit.html\"></a></td>");
                }
            }
            else{
                console.log("休班");
    ...
    $.get("http://localhost:8080/nexteer/dashboard/output/BEPS?time="+currTime,function (data) {
        if($.parseJSON(data).system_status != false){
            if($.parseJSON(data).open != false){
    ...
    $.get("http://localhost:8080/nexteer/dashboard/output/CEPS?time="+currTime,function (data) {
        if($.parseJSON(data).system_status != false){
            if($.parseJSON(data).open != false){
