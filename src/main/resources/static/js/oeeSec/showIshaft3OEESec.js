...
function showWeek() {
    ...
    var urlString = "http://localhost:8080/nexteer/oee/week/ISHAFT3?date="+curr_time;
    $.ajax({
        headers: {
...
$("#showMonth").bind("click",function (){
    ...
    $(document).ready(function () {
        ...
        console.log(MonthDate[d.getDate()-1]);
        {
            ...
            var IshaftOneoeeValueArr=[];
            var IshaftOneoeeTarArr=[];
            var urlString = "http://localhost:8080/nexteer/oee/month/ISHAFT3?date="+curr_time;
            $.ajax({
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
...
$("#showYear").bind("click",function () {
    ...
    console.log(YearDate);
    {
        ...
        var IshaftOneoeeValueArr=[];
        var IshaftOneoeeTarArr=[];
        var urlString = "http://localhost:8080/nexteer/oee/year/ISHAFT3?date="+curr_time;
        $.ajax({
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
