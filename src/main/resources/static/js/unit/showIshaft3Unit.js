...
// var myChart = echarts.init(document.getElementById('IshaftOneYieldDayChart'));
    $.get("http://10.1.0.40:8080/nexteer/unit-status/ISHAFT3?curr_time="+curTime,function (data) {
...
$("#selectHistory").bind("click",function () {
    window.location.assign("../../html/unitHistory/Ishaft3His.html");
});


$("#CN").bind("click",function () {
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">第三条中间轴单元实时数据看板 </p>");
...
// var myChart = echarts.init(document.getElementById('IshaftOneYieldDayChart'));
    ...
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">3rd I-Shaft Cell Realtime Data Board</p>");
