...
// // 基于准备好的dom，初始化echarts实例
    $.get("http://localhost:8080/nexteer/unit-status/ISHAFT4?curr_time="+curTime,function (data) {
...
$("#selectHistory").bind("click",function () {
    window.location.assign("../../html/unitHistory/Ishaft4His.html");
});


$("#CN").bind("click",function () {
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">第四条中间轴单元实时数据看板 </p>");
...
// var myChart = echarts.init(document.getElementById('IshaftOneYieldDayChart'));
    ...
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">4th I-Shaft Cell Realtime Data Board</p>");
