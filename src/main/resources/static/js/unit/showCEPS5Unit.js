...
// // 基于准备好的dom，初始化echarts实例
    $.get("http://localhost:8080/nexteer/unit-status/CEPS5?curr_time="+curTime,function (data) {
...
$("#selectHistory").bind("click",function () {
    window.location.assign("../../html/unitHistory/CEPS5His.html");
});


$("#CN").bind("click",function () {
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">无刷总组装线实时数据看板</p>");
...
// var myChart = echarts.init(document.getElementById('IshaftOneYieldDayChart'));
    ...
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">CEPS Final Asm Cell Realtime Data Board</p>");
