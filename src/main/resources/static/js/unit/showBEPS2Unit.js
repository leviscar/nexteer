...
// // 基于准备好的dom，初始化echarts实例
    $.get("http://10.1.0.40:8080/nexteer/unit-status/BEPS2?curr_time="+curTime,function (data) {
...
$("#selectHistory").bind("click",function () {
    window.location.assign("../../html/unitHistory/BEPS2His.html");
});


$("#CN").bind("click",function () {
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">有刷传感器组装线实时数据看板</p>");
...
// var myChart = echarts.init(document.getElementById('IshaftOneYieldDayChart'));
    ...
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">BEPS Sensor Asm Cell Realtime Data Board</p>");
