...
// // 基于准备好的dom，初始化echarts实例
    $.get("http://localhost:8080/nexteer/unit-status/CEPS3?curr_time="+curTime,function (data) {
...
$("#selectHistory").bind("click",function () {
    window.location.assign("../../html/unitHistory/CEPS3His.html");
});

$("#EN").bind("click",function () {
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">CEPS Sensor Asm Cell Realtime Data Board</p>");
...
$("#CN").bind("click",function () {
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">无刷传感器组装线实时数据看板</p>");
