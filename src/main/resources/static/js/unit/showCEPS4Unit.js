...
// // 基于准备好的dom，初始化echarts实例
    $.get("http://10.1.0.40:8080/nexteer/unit-status/CEPS4?curr_time="+curTime,function (data) {
...
$("#selectHistory").bind("click",function () {
    window.location.assign("../../html/unitHistory/CEPS4His.html");
});

$("#EN").bind("click",function () {
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">CEPS Jacket Asm Cell Cell Realtime Data Board</p>");
...
$("#CN").bind("click",function () {
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">无刷护管组装线实时数据看板</p>");
