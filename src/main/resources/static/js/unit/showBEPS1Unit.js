...
$("#selectHistory").bind("click",function () {
    window.location.assign("../../html/unitHistory/BEPS1His.html");
});

$("#EN").bind("click",function () {
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">BEPS Assist Mech Cell Realtime Data Board</p>");
...
$("#CN").bind("click",function () {
    $(".unitTitle").replaceWith("<p class=\"unitTitle\">有刷助力器组装线实时数据看板</p>");
