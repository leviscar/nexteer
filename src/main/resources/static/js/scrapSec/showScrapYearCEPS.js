...
function showYear() {
    ...
    $.get("http://10.1.0.40:8080/nexteer/scrap-amount/CEPS5/year?date="+YearDate[YearDate.length-1], function (data) {
...
$("#selectYearSub").bind("click",function () {
    ...
    myYearTitle.text = 'CEPS5报废金额' + $("#selectYear").val() + '年视图';
    {
        var percent=99;
        var myData=[];
        console.log("开始传输数据");
