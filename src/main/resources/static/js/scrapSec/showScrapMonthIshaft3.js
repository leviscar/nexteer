    ...
    $(document).ready(function () {
        {
            ...
            var urlString = "http://10.1.0.40:8080/nexteer/scrap-amount/"+cell+"/month/?date="+curr_time;
            $.ajax({
                headers: {
    ...
    $(document).ready(function () {
        {
            ...
            var urlString = "http://10.1.0.40:8080/nexteer/scrap-amount/"+event.data.cell+"/month/?date="+curr_time;
            $.ajax({
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
